...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports ClkSys100MhzxC]
...
set_property IOSTANDARD LVCMOS15 [get_ports RstxR]
set_property PACKAGE_PIN G4 [get_ports RstxR]
