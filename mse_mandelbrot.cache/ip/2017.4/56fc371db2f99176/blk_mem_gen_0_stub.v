...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clka, ena, wea, addra, dina, douta, clkb, enb, web, addrb, 
  dinb, doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,ena,wea[0:0],addra[19:0],dina[2:0],douta[2:0],clkb,enb,web[0:0],addrb[19:0],dinb[2:0],doutb[2:0]" */;
  input clka;
  input ena;
  input [0:0]wea;
  input [19:0]addra;
