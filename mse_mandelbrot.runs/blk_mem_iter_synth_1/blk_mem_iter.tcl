...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir /home/quartus/workspace/LPSC/mse_mandelbrot.runs/blk_mem_iter_synth_1 -new_name blk_mem_iter -ip [get_ips blk_mem_iter]]

if { $cached_ip eq {} } {

synth_design -top blk_mem_iter -part xc7a200tsbg484-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix blk_mem_iter_ blk_mem_iter.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_iter_stub.v
 lappend ipCachedFiles blk_mem_iter_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_iter_stub.vhdl
 lappend ipCachedFiles blk_mem_iter_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_iter_sim_netlist.v
 lappend ipCachedFiles blk_mem_iter_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_iter_sim_netlist.vhdl
 lappend ipCachedFiles blk_mem_iter_sim_netlist.vhdl

 config_ip_cache -add -dcp blk_mem_iter.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips blk_mem_iter]
}

rename_ref -prefix_all blk_mem_iter_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef blk_mem_iter.dcp
create_report "blk_mem_iter_synth_1_synth_report_utilization_0" "report_utilization -file blk_mem_iter_utilization_synth.rpt -pb blk_mem_iter_utilization_synth.pb"

if { [catch {
  file copy -force /home/quartus/workspace/LPSC/mse_mandelbrot.runs/blk_mem_iter_synth_1/blk_mem_iter.dcp /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/quartus/workspace/LPSC/mse_mandelbrot.runs/blk_mem_iter_synth_1/blk_mem_iter_stub.v /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/quartus/workspace/LPSC/mse_mandelbrot.runs/blk_mem_iter_synth_1/blk_mem_iter_stub.vhdl /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/quartus/workspace/LPSC/mse_mandelbrot.runs/blk_mem_iter_synth_1/blk_mem_iter_sim_netlist.v /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/quartus/workspace/LPSC/mse_mandelbrot.runs/blk_mem_iter_synth_1/blk_mem_iter_sim_netlist.vhdl /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/quartus/workspace/LPSC/mse_mandelbrot.ip_user_files/ip/blk_mem_iter]} {
  catch { 
    file copy -force /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_stub.v /home/quartus/workspace/LPSC/mse_mandelbrot.ip_user_files/ip/blk_mem_iter
  }
}

if {[file isdir /home/quartus/workspace/LPSC/mse_mandelbrot.ip_user_files/ip/blk_mem_iter]} {
  catch { 
    file copy -force /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/blk_mem_iter/blk_mem_iter_stub.vhdl /home/quartus/workspace/LPSC/mse_mandelbrot.ip_user_files/ip/blk_mem_iter
  }
}
