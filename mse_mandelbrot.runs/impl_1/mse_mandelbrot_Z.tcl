...
set rc [catch {
  ...
  read_ip -quiet /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/clk_vga_hdmi_1024x768/clk_vga_hdmi_1024x768.xci
  read_ip -quiet /home/quartus/workspace/LPSC/mse_mandelbrot.srcs/sources_1/ip/clk_hdmi_1024x600/clk_hdmi_1024x600.xci
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force mse_mandelbrot_Z_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file mse_mandelbrot_Z_drc_opted.rpt -pb mse_mandelbrot_Z_drc_opted.pb -rpx mse_mandelbrot_Z_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force mse_mandelbrot_Z_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file mse_mandelbrot_Z_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file mse_mandelbrot_Z_utilization_placed.rpt -pb mse_mandelbrot_Z_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file mse_mandelbrot_Z_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force mse_mandelbrot_Z_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file mse_mandelbrot_Z_drc_routed.rpt -pb mse_mandelbrot_Z_drc_routed.pb -rpx mse_mandelbrot_Z_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file mse_mandelbrot_Z_methodology_drc_routed.rpt -pb mse_mandelbrot_Z_methodology_drc_routed.pb -rpx mse_mandelbrot_Z_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file mse_mandelbrot_Z_power_routed.rpt -pb mse_mandelbrot_Z_power_summary_routed.pb -rpx mse_mandelbrot_Z_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file mse_mandelbrot_Z_route_status.rpt -pb mse_mandelbrot_Z_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file mse_mandelbrot_Z_timing_summary_routed.rpt -rpx mse_mandelbrot_Z_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file mse_mandelbrot_Z_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file mse_mandelbrot_Z_clock_utilization_routed.rpt"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force mse_mandelbrot_Z_routed_error.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force mse_mandelbrot_Z.mmi }
  write_bitstream -force mse_mandelbrot_Z.bit 
  catch {write_debug_probes -quiet -force mse_mandelbrot_Z}
  catch {file copy -force mse_mandelbrot_Z.ltx debug_nets.ltx}
